...
const SidebarLink = ({ title, image, to }) => {
  return (
    <Link
      to={to}
      className="flex w-full cursor-pointer items-center justify-center rounded-md px-2 py-[6px] hover:bg-gray-200 lg:justify-start dark:hover:bg-hover-color-dark-1"
    >
