...
const WorkspaceNavigator = () => {
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center border-b border-r bg-[#F7F8F9] lg:justify-between lg:p-2 dark:border-border-color-dark dark:bg-bg-color-dark-2">
      <WorkspaceButton
