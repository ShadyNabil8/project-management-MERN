...
const MainLoading = () => {
  ...
  return (
    <div className="absolute z-50 h-screen w-screen overflow-hidden bg-white">
      <div className="absolute left-1/2 top-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center gap-5 bg-white p-5">
        ...
        <p className="text-center text-[24px] text-text-color-light md:text-[38px]">
          {randomQuote.quote}
        </p>
        <p className="text-[18px] text-text-color-light md:text-[32px]">
          {randomQuote.author}
        </p>
      </div>
    </div>
