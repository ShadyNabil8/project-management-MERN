  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-white">
      <div className="absolute left-1/2 top-1/2 flex min-h-[285px] w-[397px] max-w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded-lg bg-white px-[25px] pt-[36px] shadow-3xl">
        ...
        <button className="mt-4 flex h-[40px] w-full shrink-0 items-center justify-center rounded-lg bg-[#1090E0] font-medium text-white transition-colors hover:bg-[#157CBE]">
          Go Back
        </button>
      </div>
    </div>
